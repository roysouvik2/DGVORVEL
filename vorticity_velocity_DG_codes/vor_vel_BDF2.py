...
Solving the vorticity velocity equation for Euler using implicit BDF2
...
def compute(nx):
	...
	# First we compute initial velocity using the vorticity equation
